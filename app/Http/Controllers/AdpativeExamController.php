...
class AdpativeExamController extends Controller
{
    ...
    public function topicAdaptiveExam(Request $request)
    {
        ...
        return view('afterlogin.AdaptiveExamTopic.adaptiveExam', compact('session_id', 'test_type', 'exam_type', 'question_data', 'tagrets', 'option_data', 'keys', 'activeq_id', 'next_qKey', 'prev_qKey', 'questions_count', 'exam_fulltime', 'filtered_subject', 'activesub_id'));
    }
