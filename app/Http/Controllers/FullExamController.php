    ...
    public function exam(Request $request, $exam_name, $inst = '')
    {
        try {
            ...
            if (isset($inst) && $inst === 'instruction') {
                ...
                return view('afterlogin.ExamViews.exam', compact('filtered_subject', 'tagrets', 'question_data', 'option_data', 'keys', 'activeq_id', 'next_qid', 'prev_qid', 'questions_count', 'exam_fulltime',  'exam_name', 'activesub_id', 'test_type', 'exam_type', 'exam_mode', 'series_id'));
            }
        } catch (\Exception $e) {
