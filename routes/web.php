...
Route::any('/trial_subscription/{package_id}/{exam_year}/{exam_id}', [App\Http\Controllers\SubscriptionController::class, 'trial_subscription'])->name('trial_subscription')->middleware('auth');
...
Route::get('/DailyTask-exam/{type}/{task_type}/{skill?}', [App\Http\Controllers\HomeController::class, 'dailyTaskExam'])->name('dailyTaskExam')->middleware('auth', 'menu');
