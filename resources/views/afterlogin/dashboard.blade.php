                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide bg-white go2Planner weekylplan-block weekly-plan-test">
                            ...
                            <div class="test-attend text-center pt-2 pb-2">
                                ...
                                <button class="custom-btn-gray mt-4" data-bs-toggle="collapse" href='#collapsePlanner' role="button" aria-expanded="false" aria-controls="collapseExample"><img src="{{URL::asset('public/after_login/new_ui/images/clock-icon.png')}}" alt="icon not find"  style="width:15px;">Go To
                                    Planner</button>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide bg-white go2Planner weekylplan-block">
                            ...
                            <div class="test-attend text-center pt-2 pb-2">
                                <div class="text-center" style="font-size: 14px;max-width: 180px;margin: 0 auto;">
                                    ...
                                    <button class="custom-btn-gray" style="margin-top:24px;" data-bs-toggle="collapse" href='#collapsePlanner' role="button" aria-expanded="false" aria-controls="collapseExample"><img src="{{URL::asset('public/after_login/new_ui/images/clock-icon.png')}}" alt="icon not find" style="width:15px;">Go To
                                        Planner</button>
                                </div>
                            </div>
                        </div>
