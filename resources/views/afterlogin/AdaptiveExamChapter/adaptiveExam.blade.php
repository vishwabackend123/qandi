                                ...
                                <div id="question_section" class="">
                                    ...
                                    <div class="question-block">
                                        ...
                                        <span style="visibility:hidden">
                                            <button href="javascript:void(0);" {{empty($prev_qKey)?'disabled':''}} id="quesprev{{ $activeq_id }}" onclick="qnext('{{$prev_qKey}}')" class="arrow prev-arow {{empty($prev_qKey)?'d-none':''}}"><i class="fa fa-angle-left" title="Previous Question"></i></button>
                                        ...
                                        <sapn class="question_difficulty_tag small">
                                            <span class="small me-1">Subject Id: {!! $subject_id !!}</span> |
                                            <span class="small mx-1">Chapter Id: {!! $chapter_id !!}</span> |
                                            <span class="small mx-1">Topic Id: {!! $topic_id !!}</span> |
                                            <span class="small mx-1">Question Id: {!! $activeq_id !!}</span> |
                                            <span class="small mx-1">Track: {!! $track !!}</span> |
                                            <span class="small ms-1">Difficulty Level: {!! $difficulty_level !!}</span>
                                        </sapn>
                                        @endif
                                        <!-- Static data  for demo -->
        ...
        <div class="modal-content rounded-0 ">
            <div class="modal-body p-5 text-center">
                <div class="text-center py-4">
                    <p class="mb-3" id="endMsg">You have practiced enough questions in this chapter. It's time to move to another chapter.</p>
            ...
            <div class="modal-body pt-3 p-5">
                <div class="row">
                    <div class="col-lg-12 col-xl-8">
                        <h3 class="text-danger text-uppercase examhead mb-0 pb-0 mt-4 pt-2">{{$test_name}} </h3>
                        <div class="scroll">
                            <div class="test-info">
