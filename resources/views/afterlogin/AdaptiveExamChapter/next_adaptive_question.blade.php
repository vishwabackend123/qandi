...
<div>
    ...
    <div class="question-block">
        <span style="visibility:hidden">
            ...
            <button href="javascript:void(0);" {{empty($prev_qid)?'d-none':''}} id="quesprev{{ $activeq_id }}" onclick="qnext('{{$prev_qid}}')" class="arrow prev-arow {{empty($prev_qKey)?'d-none':''}}"><i class="fa fa-angle-left" title="Previous Question"></i></button>
