...
<div>
    ...
    <div class="question-block">
        <span style="visibility:hidden">
            ...
            <button href="javascript:void(0);" id="quesprev{{ $activeq_id }}" onclick="qnext('{{$prev_qid}}')" class="arrow prev-arow {{($qNo==1)?'d-none':''}}"><i class="fa fa-angle-left" title="Previous Question"></i></button>
    ...
    <div class="tab-btn-box  d-flex mt-3">
        ...
        <a href="javascript:void(0);" class="btn px-5   btn-light-green rounded-0 saveanswer quesBtn" onclick="saveAnswer('{{$activeq_id}}','{{$qNo}}')">Save & Next</a>
