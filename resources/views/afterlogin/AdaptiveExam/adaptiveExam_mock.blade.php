    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content rounded-0">
            <div class="modal-header pb-0 border-0">
                <a type="button" class="btn-close" aria-label="Close" href="{{url('/mockExamTest')}}" title="Close">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-5 col-lg-5">
                                        ...
                                        <div>
                                            ...
                                            <span class="d-block inst-text"><span class="inst-text">{{$questions_count}} Questions</span> </span>
                                        </div>
                                    </div>
...
<div class="modal fade" id="FullTest_Exam_Panel_Interface_A" tabindex="-1" role="dialog" aria-labelledby="FullTest_Exam_Panel_Interface_A" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-0">
            <div class="modal-header pb-0 border-0">
                <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="start()" title="Close">
                    <img src="{{URL::asset('public/after_login/new_ui/images/cross.png')}}" />
                </a>
            </div>
