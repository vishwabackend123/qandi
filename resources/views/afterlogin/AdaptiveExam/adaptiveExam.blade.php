            ...
            <div class="modal-body pt-3 p-5">
                <div class="row">
                    ...
                    <div class="col-md-4 ps-lg-5 d-flex align-items-center justify-content-center flex-column">
                        ...
                        <div class="text-left   ">
                            <button class="btn  text-uppercase rounded-0 px-5 goto-exam-btn" id="goto-exam-btn" data-bs-dismiss="modal" aria-label="Close">GO FOR IT &nbsp;&nbsp;&nbsp; <img src="{{URL::asset('public/after_login/images/goforimg.png')}}" /></button>
                        </div>
                    </div>
                </div>
            </div>
