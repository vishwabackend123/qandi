...
@section('content')
                        ...
                        <div class="tab-wrapper mt-0">
                            <ul class="nav nav-tabs cust-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="overall-tab" data-bs-toggle="tab" href="#overall"
                                       role="tab" aria-controls="home" aria-selected="true" onclick="nxtTab(null)">OVERALL</a>
                                </li>
                                @foreach($user_subjects as $val)
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link " id="home-tab-{{$val->id}}" data-bs-toggle="tab"
                                           href="#home" role="tab" aria-controls="home" aria-selected="true"
                                           onclick="nxtTab('{{$val->id}}')">{{$val->subject_name}}</a>
                                    </li>
                                @endforeach
                                <li class="ms-auto d-flex">
                                    <button onclick="get_upcomming_tutorials()"
                                            class="btn btn-outline-danger px-4 text-uppercase  rounded-0 ms-auto me-3 ">
                                        Upcoming Tutorial
                                    </button>
                                    <a class="btn btn-danger rounded-0 py-2 px-5 h-100 d-flex justify-content-center align-items-center"
                                       href="#" data-bs-toggle="modal" data-bs-target="#exportAnalytics"><i
                                            class="me-2 fa fa-download"></i> Export Analytics</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="overall" role="tabpanel"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="bg-white shadow-lg h-100">
                                                <div class="row p-0 m-0">
                                                    <div class="col-12 ps-0 pe-0">
                                                        <div
                                                            class="d-flex justify-content-center flex-column h-100  position-relative">
                                                            <div id="scorecontainer" class="text-right"></div>
                                                            <span
                                                                class=" bg-light p-3 d-flex  justify-content-center flex-column ">
                                                ...
                                                @if(!empty($subProf))
                                                    @foreach($subProf as $key=>$sub)
                                                        <div class="d-flex align-items-center m-2 mt-3 pb-1">
                                                            ...
                                                            <div
                                                                class=" d-flex align-items-center   py-2 dashboard-listing-details w-100  me-4">
                                                                <span
                                                                    class="mr-3 dashboard-name-txt sub-name-box">{{$sub->subject_name}}</span>
                                                            ...
                                                            <div class="progress  col-md-6" style="overflow: visible;">
                                                                @if(isset($sub->correct_ans) && $sub->correct_ans > 0)
                                                                    <div
                                                                        ...
                                                                        role="progressbar"
                                                                        style="width:{{($sub->total_questions>0)?round(($sub->correct_ans * 100)/$sub->total_questions):0}}%;overflow: visible;">
                                                                ...
                                                                @if(isset($sub->incorrect_ans) && $sub->incorrect_ans > 0)
                                                                    <div
                                                                        class="progress-bar bg-light-red position-relative"
                                                                        role="progressbar"
                                                                        style="width:{{($sub->total_questions>0)?round(($sub->incorrect_ans * 100)/$sub->total_questions):0}}%;overflow: visible;">
                                                                        <span class="prog-box red"
                                                                              data-bs-toggle="tooltip"
                                                                              data-bs-placement="top"
                                                                ...
                                                                @if(isset($sub->unanswered) && $sub->unanswered > 0)
                                                                    <div
                                                                        ...
                                                                        role="progressbar"
                                                                        style="width:{{($sub->total_questions>0)?round(($sub->unanswered * 100)/$sub->total_questions):0}}%;overflow: visible;">
                                                        <span class="prog-box secondary"
                                                              data-bs-custom-class="tooltip-gray"
                                                              data-bs-toggle="tooltip" data-bs-placement="top"
                                                              title="Unanswered">{{round($sub->unanswered)}}
                                                        </span>
                                                                    </div>
                                                                @endif
                                                            </div>
                                        ...
                                        <div class="col-lg-5 mt-3">
                                            <div id="timeManagementBox"
                                                 class="bg-white shadow-lg p-3 h-100 px-4 text-center">
                                                ...
                                                <div id="timeManagementButtons"
                                                     class="btn-block mt-5 d-flex justify-content-between">
                                                    <button
                                                        class="btn btn-outline-secondary btn-light-green text-uppercase rounded-0 px-5 timeClass"
                                                        id="day_time" onclick="replace('day','week','month')">
                                                        Day
                                                    </button>
                                                    <button
                                                        class="btn btn-outline-secondary text-uppercase rounded-0 px-5 timeClass"
                                                        id="week_time" onclick="replace('week','day','month')">
                                                        Week
                                                    </button>
                                                    <button
                                                        class="btn btn-outline-secondary text-uppercase rounded-0 px-5 timeClass"
                                                        id="month_time" onclick="replace('month','day','week')">
                                                        Month
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-5 mt-3">
                                            <div class="bg-white shadow-lg p-3 h-100 px-4 text-center">
                                                ...
                                                <div class="btn-block mt-5 d-flex justify-content-between">
                                                    <button
                                                        class="btn btn-outline-secondary btn-light-green text-uppercase rounded-0 px-5 classMark"
                                                        id="day_mark" onclick="replace1('day1','week1','month1')">
                                                        Day
                                                    </button>
                                                    <button
                                                        class="btn btn-outline-secondary text-uppercase rounded-0 px-5 classMark"
                                                        id="week_mark" onclick="replace1('week1','day1','month1')">
                                                        Week
                                                    </button>
                                                    <button
                                                        class="btn btn-outline-secondary text-uppercase rounded-0 px-5 classMark"
                                                        id="month_mark" onclick="replace1('month1','day1','week1')">
                                                        Month
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-white shadow-lg p-3 mt-3 px-5">
                                                <div class="d-flex">
                                                    <a href="{{url('/dashboard')}}"
                                                       class="btn btn-outline-secondary rounded-0 w-50 me-4">Back
                                                        to Dashboard
                                                    </a>
                                                    <button class="btn btn-outline-danger rounded-0 w-50 ms-4 ms-auto"
                                                            data-bs-toggle="modal" data-bs-target="#exportAnalytics">
    ...
    <div class="modal fade" id="upcoming-tutorials" tabindex="-1" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
