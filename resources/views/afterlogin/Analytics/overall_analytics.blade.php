                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="tab-wrapper">
                            <ul class="nav nav-tabs cust-tabs" id="myTab" role="tablist">
                                ...
                                {{--                                       aria-controls="profile" aria-selected="false">Physics</a>--}}
                                {{--                                </li>--}}
                                {{--                                <li class="nav-item" role="presentation">--}}
                                {{--                                    <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#contact" role="tab"--}}
                                {{--                                       aria-controls="contact" aria-selected="false">Chemistry</a>--}}
                                {{--                                </li>--}}
                                <li class="ms-auto">
                            ...
                            <div class="tab-content cust-tab-content" id="myTabContent">
                                                ...
                                                <div class="row">
                                                    <div class="col-8 pe-0">
                                                        <div
                                                            ...
                                                            <a href="javascript:;"
                                                               class="fa fa-info-circle fa-1x text-light ms-auto mt-2 position-absolute top-0 end-0"
                                                               data-bs-toggle="popover"
                                                               data-bs-content="And here's some amazing content. It's very engaging. Right?"></a>

                                                        <!-- <span class=" p-3"><img src="{{URL::asset('public/after_login/images/left-graph.jpg')}}"></span> -->
                                                            <div id="scorecontainer" class="text-right"></div>
                                                            <span
                                                                class=" bg-light p-3 d-flex  justify-content-center flex-column graph-bottom-block">
                                                    ...
                                                    <div class="col-4  ">
                                                        <div
                                                            class="d-flex flex-column h-100 montain-bg inactive-mountain">
                                                            <span></span>
                                                            <span
                                                                class="mt-auto mb-4  d-flex justify-content-center align-items-center  montain-txt">
                                                    ...
                                                    @foreach($subProf as $key=>$sub)
                                                        <div class="d-flex align-items-center mt-3 pb-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="mr-3 dashboard-name-txt">{{$sub->subject_name}}</span>
                                        ...
                                        <div class="col-lg-7  mt-3">
                                            <div class="bg-white shadow-lg p-3 h-100 px-5">
                                                <p class="text-uppercase fw-bold text-start">Average Time Spent on each
                                                    Question</p>
                                                <img src="{{URL::asset('public/after_login/images/innergraph2.png')}}"
                                                     class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 mt-3">
                                ...
                                {{--                                                                                            <span class=" p-3"><img--}}
                                {{--                                                                                                    src="{{URL::asset('public/after_login/images/left-graph.jpg')}}"></span>--}}
                                {{--                                                                                            <span--}}
                                ...
                                {{--                                                                                        <div--}}
                                {{--                                                                                            class="status-id   d-flex align-items-center justify-content-center ml-0 ml-md-3 rating"--}}
                                {{--                                                                                            data-vote="0">--}}
                                ...
                                {{--                                                                                        Day--}}
                                {{--                                                                                    </button>--}}
                                {{--                                                                                    <button class="btn btn-light-green text-uppercase rounded-0 px-5">--}}
                                {{--                                                                                        Week--}}
                                {{--                                                                                    </button>--}}
                                {{--                                                                                    <button--}}
                                {{--                                                                                        class="btn btn-outline-secondary text-uppercase rounded-0 px-5">--}}
