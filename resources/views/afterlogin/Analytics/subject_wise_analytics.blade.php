                        ...
                        <div class="row position-relative h-100">
                            @if($skillPer)
                                <div class="col-6 mb-2 pe-1 h-48">
                                    <div class="bg-white shadow-lg d-flex justify-content-center flex-column h-100 ">
                                        <a class="box-block arrow-right-btm" data-bs-toggle="collapse"
                                           href="#arrow-right-btm">
                                            <span>{{substr($skillPer[0]->skill_name, 0, 1)}}</span>
                                            <span>{{round($skillPer[0]->percentage)}}%</span>
                                        </a>
                                    </div>
                                    <div class="collapse arrow-right-btm-content p-3" data-bs-dismiss="collapse"
                                         id="arrow-right-btm">
                                        ...
                                        <p></p>
                                        <a class="inner-arrow-right-btm" data-bs-toggle="collapse"
                                           href="#arrow-right-btm"><i class="fa fa-angle-down"
                                ...
                                <div class="col-6  mb-2 ps-1 h-48">
                                    ...
                                    <div class="collapse arrow-right-btm-content p-3" data-bs-dismiss="collapse"
                                        ...
                                        <p></p>
                                        <a class="inner-arrow-left-btm" data-bs-toggle="collapse"
                                           href="#arrow-left-btm"><i class="fa fa-angle-down"
                                                                     aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <div class="col-6 pe-1 h-48">
                                    ...
                                    <div class="collapse arrow-right-btm-content p-3" data-bs-dismiss="collapse"
                                        ...
                                        <p></p>
                                        <a class="inner-arrow-right-top" data-bs-toggle="collapse"
                                           href="#arrow-right-top"><i class="fa fa-angle-down"
                                                                      aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <div class="col-6 ps-1 h-48">
                                    ...
                                    <div class="collapse arrow-right-btm-content p-3" data-bs-dismiss="collapse"
                                        ...
                                        <p></p>
                                        <a class="inner-arrow-left-top" data-bs-toggle="collapse"
                                           href="#arrow-left-top"><i class="fa fa-angle-down"
                                                                     aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="d-flex align-items-center mt-3 pb-1">
                                ...
                                <div class="progress  ms-auto col-5" style="overflow: visible;">
                                    @if($val->correct_ans > 0)
                                        <div class="progress-bar bg-light-success position-relative" role="progressbar"
                                             style="width:{{($val->total_questions>0)?round(($val->correct_ans * 100)/$val->total_questions):0}}%;overflow: visible;">
                                            <span class="prog-box green" data-bs-toggle="tooltip"
                                                  data-bs-custom-class="tooltip-green" data-bs-placement="top"
                                                  title="Correct">{{round($val->correct_ans)}}</span>
                                        </div>
                                    @endif
                                    @if($val->incorrect_ans > 0)
                                        <div class="progress-bar bg-light-red position-relative" role="progressbar"
                                             style="width:{{($val->total_questions>0)?round(($val->incorrect_ans * 100)/$val->total_questions):0}}%;overflow: visible;">
                                            <span class="prog-box red" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    @if($val->unanswered > 0)
                                        <div class="progress-bar bg-light-secondary position-relative"
                                             role="progressbar"
                                             style="width:{{($val->total_questions>0)?round(($val->unanswered * 100)/$val->total_questions):0}}%;overflow: visible;">
                                <span class="prog-box secondary" data-bs-custom-class="tooltip-gray"
                                      data-bs-toggle="tooltip" data-bs-placement="top" title="Unanswered">{{round($val->unanswered)}}
                                </span>
                                        </div>
                                    @endif
                                </div>
    ...
    <div class="row">
        <div class="col-lg-5 mt-3">
            <div class="bg-white shadow-lg p-3 h-100 px-3 text-center">
                ...
                <div class="btn-block mt-5 d-flex justify-content-between">
                    <button class="btn btn-outline-secondary btn-light-green text-uppercase rounded-0 px-5 s_timeClass"
                            id="s_day_time" onclick="replace('day','week','month')">
                        Day
                    </button>
                    <button class="btn btn-outline-secondary text-uppercase rounded-0 px-5 s_timeClass" id="s_week_time"
                            onclick="replace('week','day','month')">
                        Week
                    </button>
                    <button class="btn btn-outline-secondary text-uppercase rounded-0 px-5 s_timeClass"
                            id="s_month_time" onclick="replace('month','day','week')">
                        Month
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-5 mt-3">
            <div class="bg-white shadow-lg p-3 h-100 px-3 text-center">
                ...
                <div class="btn-block mt-5 d-flex justify-content-between">
                    <button class="btn btn-outline-secondary btn-light-green text-uppercase rounded-0 px-5 s_classMark"
                            id="s_day_mark" onclick="s_replace1('day1','week1','month1')">
                        Day
                    </button>
                    <button class="btn btn-outline-secondary text-uppercase rounded-0 px-5 s_classMark" id="s_week_mark"
                            onclick="s_replace1('week1','day1','month1')">
                        Week
                    </button>
                    <button class="btn btn-outline-secondary text-uppercase rounded-0 px-5 s_classMark"
                            id="s_month_mark" onclick="s_replace1('month1','day1','week1')">
                        Month
                    </button>
                </div>
            </div>
        ...
        <div class="col-lg-7  mt-3">
            ...
            <div class="bg-white shadow-lg p-3 mt-3 px-5">
                <div class="d-flex">
                    ...
                    <button class="btn btn-outline-danger rounded-0 w-50 ms-4 ms-auto" data-bs-toggle="modal"
                            data-bs-target="#exportAnalytics">
...
{{--                <button class="btn btn-warning px-4 text-uppercase rounded-0 ms-auto topic-btn-collepse"--}}
{{--                        id="topic-btn-collepse"><i class="fa fa-compress" aria-hidden="true"></i>--}}
{{--                    COLLAPSE--}}
{{--                </button>--}}
{{--            </div>--}}
                ...
                <div class="col-md-6 col-lg-4 mb-4 ">
                    <div class="bg-white shadow-lg p-3 sub-topic-box active-box">
                        ...
                        <div class="progress" style="overflow: visible;">
                            ...
                            <div class="progress-bar bg-light-secondary position-relative" role="progressbar"
...
<script>
    Highcharts.chart('subjectscorecontainer', {
        ...
        title: {
            text: '<span style="font: normal normal 200 74px/111px Poppins; letter-spacing: 0px; color: #231F20;">{{isset($subScore[1]->score)??0}}</span> <br><span style="font: normal normal normal 18px/27px Poppins;letter-spacing: 0px;color: #231F20;"> / 100 </span>',
            align: 'center',
