...
@section('content')
                                            ...
                                            <div class="bg-white shadow-lg p-5 report-analysis-block">
                                                <div class="d-flex align-items-center border-bottom pb-4">
                                                    ...
                                                    <div class="ms-auto d-flex align-items-center">
                                                        <div>
                                                            <img id="imageid" src="{{$imgPath}}" class="exportUserpic"
                                                                 alt="image"/>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="star-ratings-css m-0 me-3">
                                                                <div class="star-ratings-css-top"
                                                                     style="width: {{round($overall_prof_perc)}}%">
                                    ...
                                    @if(!empty($subProf))
                                        @foreach($subProf as $key=>$sub)
                                            <div class="d-flex align-items-center mt-3 pb-1">
                                                <div class="  col-6">
                                                    <div
                                                        class="row d-flex  align-items-center py-2 dashboard-listing-details  w-100 col-6">
                                                        <span
                                                            class="col-md-6 mr-3 dashboard-name-txt">{{$sub->subject_name}}</span>
                                                        <div
                                                            class="col-md-6 status-id d-flex align-items-center justify-content-center ml-0 ml-md-3 rating"
                                                            data-vote="0">
                                                            <div
                                                                class="status-id  ms-auto  d-flex align-items-center justify-content-center ml-0 ml-md-3 rating"
                                                                data-vote="0">
                                                ...
                                                <div class="progress ms-auto col-6" style="overflow: visible">
                                                    @if($sub->correct_ans > 0)
                                                        <div class="progress-bar bg-light-green position-relative"
                                                             role="progressbar"
                                            ...
                                            <span class="prog-box secondary" data-bs-custom-class="tooltip-gray"
                                                  data-bs-toggle="tooltip" data-bs-placement="top" title="Unanswered">{{round($sub->unanswered)}}
                                            </span>
                                                        </div>
                                                    @endif
                                                </div>
                                        ...
                                        @if(!empty($unitProf))
                                            @foreach($unitProf as $key=>$unit)
                                                <div class="col-md-12 border-bottom pt-2">
                                                    <span
                                                        class="dashboard-name-txt fw-bold">{{$unit->subject_name}}</span>
                                                    <div class="px-4">
                                                        @if(isset($unit->unit_score))
                                                            @foreach($unit->unit_score as $unit)
                                                                <div class="d-flex align-items-center  ">
                                                                    ...
                                                                    <div
                                                                        class="row d-flex  align-items-center py-1 dashboard-listing-details  w-100 col-6">
                                                                        <span
                                                                            class="col-md-6 mr-3 dashboard-name-txt">{{$unit->uni_name}}</span>
                                                                        <div
                                                                            class="col-md-6 status-id d-flex align-items-center justify-content-center ml-0 ml-md-3 rating"
                                                                            data-vote="0">
                                                                            <div
                                                                                ...
                                                                                <div class="star-ratings-css">
                                                                                    <div class="star-ratings-css-top"
                                                                                         style="width:{{round($unit->score)}}%">
                                                                                        <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                                                                                    </div>
                                                                                    <div
                                                                                        class="star-ratings-css-bottom">
                                                                                        <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="ms-1 score score-rating js-score">
                                                                                    {{round($unit->score)}}%
                                                                                </div>
                                                                            </div>
                                                                        </div>
    ...
    <div id="editor">
        <a id="cmd" href="javascript:void(0);" class="export-btn" onclick="CreatePDFfromHTML()"><img
                src="{{URL::asset('public/after_login/new_ui/images/download-iccon.png')}}"></a>
        <a href="{{ url('/dashboard') }}" class="close-btn"><img
                src="{{URL::asset('public/after_login/new_ui/images/close-icoons.png')}}"></a>
    </div>
