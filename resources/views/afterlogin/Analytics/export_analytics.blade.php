            ...
            <div class="container-fluid">
                <div class="row">
                  ...
                  Weekly UniQ Performace Report<br/>{{date("F j, Y")}}
                                            ...
                                            <div class="d-flex align-items-center mt-3 pb-1">
                                                <div class="  col-6">
                                                    <div class="row d-flex  align-items-center py-2 dashboard-listing-details  w-100 col-6">
                                                        ...
                                                        <div class="col-md-6 status-id d-flex align-items-center justify-content-center ml-0 ml-md-3 rating"
                                                             data-vote="0">
                                                            <div class=" status-id
                            d-flex
                            align-items-center
                                                ...
                                                <div class="progress ms-auto col-6" style="overflow: visible">
                                                    ...
                                                    <div class="progress-bar bg-light-red position-relative"
                                                        ...
                                                        <span class="prog-box red" data-bs-toggle="tooltip"
                                                              data-bs-placement="top" data-bs-custom-class="tooltip-red"
                      ...
                      <span class="prog-box secondary" data-bs-custom-class="tooltip-gray" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Unanswered">{{round($sub->unanswered)}}
                      </span>
                                                    </div>
                                                </div>
                                            </div>
