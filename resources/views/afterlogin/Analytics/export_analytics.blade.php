            ...
            <div class="col-lg-10 ps-lg-5 mx-auto">
              ...
              <div class="bg-white">
                  ...
                  <div class="export-block">
                    ...
                    <div class="row">
                      <div class="mx-auto col-md-10">
                        <div
                          class="bg-white shadow-lg p-5 report-analysis-block"
                        >
                          <div
                            class="d-flex align-items-center border-bottom pb-4"
                          >
                            <div>
                            ...
                            <div class="ms-auto d-flex align-items-center">
                              ...
                              <div class="exportUsertxt">
                                <p>Anuj Bharadwaj</p>
                                <small
                                  ><strong>Class - 12th</strong>, Preparingfor
                                  JEE(M), April 2022
                                </small>
                              </div>
                            </div>
                          ...
                          <div class="row py-5">
                            <div class="col-md-4 text-center">
                              ...
                              >
                                <i
                                  class="fa fa-star text-warning me-2"
                                  aria-hidden="true"
                                ></i>
                                <i
                                  class="fa fa-star text-warning me-2"
                                ...
                                ></i>
                                <i
                                  class="fa fa-star-half text-warning me-2"
                                  aria-hidden="true"
                                ></i>
                ...
                <div class="report-block2 p-5">
                  ...
                  <div class="bg-white shadow-lg p-3 mt-5">
                    ...
                    <div class="d-flex align-items-center mt-3 pb-1">
                      <div
                        ...
                        "
                      >
                        <span class="mr-3 dashboard-name-txt"
                          >Trigonometry</span
                        >
                        ...
                        >
                          <div class="star hidden animate">
                            <span
                              class="full star-colour"
                              data-value="0"
                            ></span>
                            <span
                              class="half star-colour"
                              data-value="0"
                            ></span>
                          </div>
                  ...
                  <div
                    class="bg-white shadow-lg p-3 h-100 px-5 mt-3 text-center"
                  >
                ...
                <div class="report-block1 p-5">
                  <div class="d-flex align-items-center p-5">
                    ...
                    <div class="ms-auto d-flex align-items-center">
                      ...
                      <div class="exportUsertxt">
                        <p>Anuj Bharadwaj</p>
                        <small
                          ><strong>Class - 12th</strong>, Preparingfor JEE(M),
                          April 2022
                        </small>
                      </div>
                    </div>
                  ...
                  <div class="p-5">
                    <div class="d-flex mt-3">
                      <i
                        class="fa fa-check-square me-3 mt-1 text-warning"
                        aria-hidden="true"
                      ></i>
                  ...
                  <p class="text-center mt-5 pt-5">
                    <a
                      href="https://www.uniq.co.edu/signup"
                      class="link-primary"
                      target="_blank"
                      >To Know more: https://www.uniq.co.edu/signup</a
                    >
                  </p>
                </div>
              </div>
