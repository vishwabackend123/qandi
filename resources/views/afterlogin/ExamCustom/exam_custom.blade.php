                                ...
                                <div class="take-fulltest d-lg-flex align-items-center justify-content-end {{($skey==0)?'d-lg-flex':'d-none'}}" id="{{$sub->subject_name}}_main">
                                    ...
                                    <div class="full_take {{($skey==0)?'d-flex':'d-none'}}" id="{{$sub->subject_name}}_test">
                                        ...
                                        <ul class="dropdown-menu filterdropdown">
                                            <li class="text-right"><a id="clear-filter-{{$sub->id}}" href="javascript:void(0);" class="dropdown-item fliterclr" onclick="clear_chapter_filter('{{$sub->id}}','clear')">CLEAR</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="chapterlist_filter('{{$sub->id}}','prof_asc')"><svg xmlns="http://www.w3.org/2000/svg" data-name="Group 4864" width="24" height="24" viewBox="0 0 24 24">
                                            ...
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="chapterlist_filter('{{$sub->id}}','prof_desc')"><svg xmlns="http://www.w3.org/2000/svg" data-name="Group 2976" width="24" height="24" viewBox="0 0 24 24">
                                            ...
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="chapterlist_filter('{{$sub->id}}','asc')"><svg xmlns="http://www.w3.org/2000/svg" data-name="Group 2978" width="24" height="24" viewBox="0 0 24 24">
                                            ...
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="chapterlist_filter('{{$sub->id}}','desc')"><svg xmlns="http://www.w3.org/2000/svg" data-name="Group 2979" width="24" height="24" viewBox="0 0 24 24">
