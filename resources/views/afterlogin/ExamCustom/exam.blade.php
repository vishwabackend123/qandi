...
<script type="text/javascript"
        src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML-full"></script>
...
@section('content')
    ...
    <div class="main-wrapper p-0 bg-gray">
                                    ...
                                    @foreach($filtered_subject as $key=>$sub)
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link all_div class_{{$sub->id}} @if($activesub_id==$sub->id) active @endif "
                                               ...
                                               @if(count($filtered_subject)>1) onclick="get_subject_question('{{$sub->id}}')" @endif>{{$sub->subject_name}}</a>
                                        </li>
                                    ...
                                    <div class="d-flex" id="pause-start">
                                        <div id="counter_{{$activeq_id}}" class="ms-auto counter mb-4 d-flex">
                                            ...
                                            <div class="time_taken_css" id="q_time_taken_first" style="display:none;">
                                                <span>Time taken : </span><span id="up_minutes"></span>:<span
                                                    id="up_seconds"></span>mins
                                            </div>
                                        </div>
                                            ...
                                            @if(isset($option_data) && !empty($option_data))
                                                ...
                                                @foreach($option_data as $key=>$opt_value)
                                                    ...
                                                    <div class="col-md-6 mb-4">
                                                        <input class="form-check-input selctbtn radioans" type="radio"
                                        ...
                                        <div class="N_tab-btn-box_list">
                                            <div class="ps-3" style="float:left">
                                                ...
                                                @else
                                                    <button
                                                        class="btn px-5  pull-left btn-light-green rounded-0 saveanswer text-capitalize"
                                                        onclick="saveAnswer('{{$activeq_id}}')">Save & Submit
                                                    </button>
                                                @endif

                                                <button
                                                    class="btn px-4 ms-2 btn-light rounded-0 btn-secon-clear savemarkreview text-capitalize"
                                                    onclick="savemarkreview('{{$activeq_id}}','{{$subject_id}}')">Save &
                                                    Mark for review
                                                </button>
                                            </div>
                                            <div class="pe-3" style="float:right">
                                                ...
                                                <button
                                                    ...
                                                    onclick="clearResponse('{{$activeq_id}}','{{$subject_id}}',1)">Clear
                                                    Response
                                                </button>
                                            </div>
        ...
        <div class="modal fade" id="test_instruction" tabindex="-1" aria-labelledby="exampleModalLabel"
