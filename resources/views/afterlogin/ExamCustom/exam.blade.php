                                ...
                                <div class="tab-btn-box  d-flex mt-3 N_tab-btn-box">
                                    <div class="N_tab-btn-box_list">
                                        <div class="ps-3" style="float:left">
                                            ...
                                            @else
                                            <button class="btn px-5  pull-left btn-light-green rounded-0 saveanswer text-capitalize" onclick="saveAnswer('{{$activeq_id}}')">Save & Submit
                                            </button>
                                            @endif

                                            <button class="btn px-4 ms-2 btn-light rounded-0 btn-secon-clear savemarkreview text-capitalize" onclick="savemarkreview('{{$activeq_id}}','{{$subject_id}}')">Save &
                                                Mark for review
                                            </button>
                                        </div>
                                        <div class="pe-3" style="float:right">
                                            ...
                                            <button class="btn px-4 ms-2 btn-secon-clear act rounded-0 text-capitalize" onclick="clearResponse('{{$activeq_id}}','{{$subject_id}}',1)">Clear
                                                Response
                                            </button>
                                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="scroll">
                                ...
                                <div class="instructions pe-3">
                                    ...
                                    <p>This will give multiple opportunities to the candidates to improve their
                                        scores in the
                                    ...
                                    <p>In first attempt, the students will get a first-hand experience of taking an
                                        examination and will know their mistakes which they can improve while
                                        attempting
                                        for the next time.</p>
                                    <p>This will reduce the chances of dropping a year and droppers would not have
                                        to
                                        waste a full year.</p>
