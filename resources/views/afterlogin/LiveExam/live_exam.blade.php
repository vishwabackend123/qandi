                            ...
                            <div class="examTabheader">
                                <div class="tablist">
                                    <ul class="nav nav-tabs mobilescrolltab mobilescrolltabNew" role="tablist" id="myTab">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <span class="qCount qcountout qcountout_2  countActive">{{$sub->count}}</span>
                                        </li>
                                        @endforeach
                                        @endif
                                    </ul>
                                ...
                                <div class="submitBtn">
                                    <form id="form_exam_submit" action="{{route('exam_result')}}" method="post">
                                        ...
                                        <input type="hidden" name="exam_name" value="{{isset($exam_name)?$exam_name:'Live Exam'}}">
            ...
            <div class="modal-content exammodal_content">
                <div class="modal-body exam-paused-body">
                    ...
                    <div id="button_width" class="exam-footer-sec width-50">
                            <div class="task-btn tasklistbtn">
                                <button class="btn btn-common-transparent nobg reviewbtn submitPopupBtn" data-bs-dismiss="modal" onclick="start()" id="back_to_restart">Back To test</button>
                                <a href="{{url('/live_exam_list')}}" id="bt-modal-confirm" class="btn btn-common-green green50 submitPopupBtn">Exit Test<label>
