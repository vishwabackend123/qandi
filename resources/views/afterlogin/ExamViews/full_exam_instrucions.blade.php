                    ...
                    <div id="inst_details">
                        <div id="inst_details">
                            ...
                            <div class="exam_instruction_scrolling">
                                <div>
                                    <div class="exam_inst_sec_head"><b>1. <span>General<span></span></span></b></div>
                                ...
                                <div>
                                    <div class="exam_inst_sec_head_flex">
                                        <div class="exam_inst_sec_head"> @if($user_exam_id == '1')
                                ...
                                <div>
                                    <div class="exam_inst_sec_head"><b>3. <span>CBT (Computer-Based Test) Instructions<span></span></span></b></div>
                                    <div class="line-693"></div>
                                    <ul class="exam_inst_ul_li">
                                        ...
                                        <li>To answer any question, choose the correct option and click on <b>“Save &amp; Next”</b> button.</li>
                                        ...
                                        <li>To mark the question for review (after answering it), click on the <b>“Save &amp; Mark for Review”</b> button.</li>
                                        <li>Click on <b>“Next Question”</b> arrow button to skip any question without answering it.</li>
                                        <li>Click on the question number in the question palette at the right side of the screen to go to that question directly. <b>Note that using this option does NOT save the answer to the currently displayed question.</b></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
