                                        ...
                                        <div class="ClickBack d-flex align-items-center justify-content-between bg-white   listing-details w-100 flex-wrap result-list-table">
                                          ...
                                          if ($time >= "19") {
                                            ...
                                            <div class="d-flex align-items-center justify-content-center morning-slot">
                                                ...
                                                <a href="{{route('get_exam_result_analytics',[$sche->id,$test_type,$test_name])}}" class="btn result-analysis"><i class="fa fa-line-chart" aria-hidden="true"></i> &nbsp;View Analytics</a>
                                            </div>
                                            <div class="result-list-btns">
                                                <a href="{{route('exam_review',[$sche->id,'attempted',,$test_name])}}" class="btn result-review w-100">Review Exam</a>
                                            </div>
                                        </div>
