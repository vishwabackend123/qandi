...
@section('content')
                                    ...
                                    @foreach($subject_list as $sub)
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link @if($subx==1) active @endif"
                                               ...
                                               aria-controls="{{$sub->subject_name}}"
                                               aria-selected="true">{{$sub->subject_name}}</a>
                                        </li>
                                        @php $subx++; @endphp
                                    @endforeach
                                @endif
                                ...
                                @if(isset($aPreparation) && !empty($aPreparation))
                                    ...
                                    @foreach($aPreparation as $oSub)
                                        ...
                                        <div class="tab-pane fade show @if($topx==1) active @endif"
                                            ...
                                            <div
                                                class="d-flex px-4 mt-4 mb-4 py-3 align-items-center justify-content-between">
                                                <span
                                            ...
                                            <div class="scroll-div">
                                                    @foreach( $oSub->values as $val)
                                                            <div
                                                                ...
                                                                <span
                                                                    class="col-md-6 mr-3 preparation-txt">{{$val->chapter_name}}
                                                                </span>
                                                                <div class="col-md-3  d-flex  align-items-center">
    ...
    <!-- Modal -->
    <div class="modal fade" id="PreparationCenter_modal" tabindex="-1" aria-labelledby="PreparationCenter_modal"
         aria-hidden="true">
                    ...
                    <div class="main-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                ...
                                <span class="me-1"><a href="javascript:void(0);" data-bs-toggle="modal"
                                                      class="bg-light-red link-dark py-3 px-2 d-inline-block"
                                                      data-bs-target="#PreparationCenter_modal"><img
                                            src="{{URL::asset('public/after_login/images/Group3081@2x.png')}}"> 34</a></span>
                                <span class="me-1"><a href="javascript:void(0);"><img
                                            src="{{URL::asset('public/after_login/images/Group3082.png')}}"> 41</a></span>
                                <span class="me-1"><a href="javascript:void(0);"><img
                                            src="{{URL::asset('public/after_login/images/Group3083.png')}}"> 28</a></span>
                                <span><a href="javascript:void(0);"><img
                                            src="{{URL::asset('public/after_login/images/Group3084.png')}}"> 127</a></span>
                        ...
                        <div class="h-scroll-slim">
                            <div class="d-flex bg-white p-3 align-items-center mt-5">
                                <span class="px-3"><img
                                        src="{{URL::asset('public/after_login/images/icon5.svg')}}"/></span>
                                <div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="PreparationCenter_Notes" tabindex="-1" aria-labelledby="PreparationCenter_modal"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 bg-light">
                <div class="modal-header pb-0 border-0">
                ...
                <div id="notes_modal_body" class="modal-body pt-0 px-5">
                    <div class="main-center">
                        ...
                        <div class="h-scroll-slim">
                            <div class="d-flex bg-white p-3 align-items-center mt-5">
                                <span class="px-3"><img
                                        src="{{URL::asset('public/after_login/images/icon6.svg')}}"/></span>
                                <div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="PreparationCenter_Video" tabindex="-1" aria-labelledby="PreparationCenter_modal"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 bg-light">
                <div class="modal-header pb-0 border-0">
                ...
                <div id="videos_modal_body" class="modal-body pt-0 px-5">
                    <div class="main-center">
                        ...
                        <div class="h-scroll-slim">
                            <div class="d-flex bg-white p-3 align-items-center mt-5">
                                <span class="px-3"><img
                                        src="{{URL::asset('public/after_login/images/icon8.svg')}}"/></span>
                                <div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="PreparationCenter_bookmark" tabindex="-1" aria-labelledby="PreparationCenter_modal"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 bg-light">
                <div class="modal-header pb-0 border-0">
                        ...
                        <div class="h-scroll-slim">
                            <div class="d-flex bg-white p-3  mt-5">
                                ...
                                <div>
                                    ...
                                    <p>AB is an arc of length 42 cm on the circumference of a circle with center O and
                                        radius 12 cm. What is the size of angle AOB in radians?</p>
