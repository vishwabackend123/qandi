<div class="main-center">
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="ms-auto">
            ...
            <span class="me-1"><a href="javascript:void(0);" title="Bookmarks" class="bg-light-red link-dark py-3 px-2 d-inline-block"><img src="{{URL::asset('public/after_login/images/Group3084.png')}}" onclick="get_chapter_wise_data('{{$preparation_list->chapter_id}}','bookmarks')"> {{$preparation_list->total_bookmarks}}</a></span>
        </div>
    </div>
