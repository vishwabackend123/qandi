<div class="main-center">
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="ms-auto">
            <span class="me-1"><a href="javascript:void(0);" title="Presentation" data-bs-toggle="modal" class="bg-light-red link-dark py-3 px-2 d-inline-block" data-bs-target="#PreparationCenter_modal"><img src="{{URL::asset('public/after_login/images/Group3081@2x.png')}}"> {{$preparation_list->total_presentations}}</a></span>
