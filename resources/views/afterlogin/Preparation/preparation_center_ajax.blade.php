...
{{--            </div>--}}
        ...
        <div class="ms-auto">
            <span class="me-1"><a href="javascript:void(0);" data-bs-toggle="modal" class="bg-light-red link-dark py-3 px-2 d-inline-block" data-bs-target="#PreparationCenter_modal"><img src="{{URL::asset('public/after_login/images/Group3081@2x.png')}}"> {{$preparation_list->total_presentations}}</a></span>
            ...
            <span><a href="javascript:void(0);"><img src="{{URL::asset('public/after_login/images/Group3084.png')}}" onclick="get_chapter_wise_data('{{$preparation_list->chapter_id}}','bookmarks')"> {{$preparation_list->total_bookmarks}}</a></span>

        </div>
    </div>
    <div class="h-scroll-slim">
        @if(!empty($preparation_list->presentation))
        @foreach($preparation_list->presentation as $pre)
