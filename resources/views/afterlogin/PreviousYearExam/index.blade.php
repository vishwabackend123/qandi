...
function sendEventPYAttempted(type)
{
    mixpanel.track(type);
}
                        ...
                        <div class="tablist">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item pe-5 me-2">
                                    <a onclick="sendEventPYAttempted('Loaded Previous Year Exam Listing')" class="nav-link qq1_2_3_4 active bg-transparent m-0" data-bs-toggle="tab" href="#mock_test" id="previous_year_tab">Previous Year Exams</a>
                                </li>
                                <li class="nav-item">
                                    <a onclick="sendEventPYAttempted('Loaded Previous Year Attempted Listing')" class="nav-link qq1_2_3_4 bg-transparent" data-bs-toggle="tab" href="#attempted_tab" id="attempted">Attempted</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Tab panes -->
