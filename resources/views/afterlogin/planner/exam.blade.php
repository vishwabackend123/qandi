            ...
            <div class="modal-body pt-3 p-5">
                <div class="row">
                    <div class="col-lg-12 col-xl-8">
                        <h1 class="text-danger text-uppercase examhead mb-0 pb-0 mt-4 pt-2">{{isset($exam_name)?$exam_name:''}}{{!empty($chapter_name)?'('.$chapter_name.')':''}}</h1>
                        <div class="scroll">
                            <div class="test-info">
...
<div class="modal fade" id="FullTest_Exam_Panel_Interface_A" tabindex="-1" role="dialog" aria-labelledby="FullTest_Exam_Panel_Interface_A" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg ">
        <div class="modal-content rounded-0">
            <div class="modal-header pb-0 border-0">
                <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="start()"><img src="{{URL::asset('public/after_login/new_ui/images/cross.png')}}" /></a>
            </div>
                ...
                <div class="modal-body exam-paused-body">
                    ...
                    <div id="button_width" class="exam-footer-sec width-50">
                            <div class="task-btn tasklistbtn">
                                ...
                                <a href="{{url('/planner')}}" id="bt-modal-confirm" class="btn btn-common-green green50 submitPopupBtn">Exit Test<label>
