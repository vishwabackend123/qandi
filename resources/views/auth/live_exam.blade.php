                        ...
                        <div id="mock_test" class=" tab-pane active">
                           ...
                           <div class="mock_test_ques_dure_marks_sub d-flex">
                              <div class="mock_test_ques_content">
                                 ...
                                 <div class="mock_test_qdms_text2"><span>10</span> Questions</div>
                              </div>
                              <div class="mock_test_dure_content">
                                 <div class="mock_test_qdms_text1">Start Date</div>
                                 <div class="mock_test_qdms_text2">1st Apr 2022</div>
                              </div>
                              <div class="mock_test_sub_content">
                                 <div class="mock_test_qdms_text1">End Date</div>
                                 <div class="mock_test_qdms_text2">4th Apr 2022</div>
                              </div>
                           </div>
                           <div>
