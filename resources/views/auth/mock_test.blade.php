               ...
               <div class="tab-content bg-white exam_tabdata">
                  <div id="qq1" class=" tab-pane active">
                    ...
                    <div class="d-flex align-items-center">
                     <button type="button" class="btn btn-common-transparent bg-transparent mr-3">Take test for selected topics</button>  
                    <a href="javascript:void(0);" class="clearsec">Clear Selection</a>
                    </div>    
                    <div>   
                    <a href="javascript:void(0)">
                <svg class="mr-4 align-bottom" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
