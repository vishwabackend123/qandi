...
@section('content')
<style>
.chapter_preficiency_warpper
{
    background:#f5faf6;
    min-height:100%;
}
.knowledge_left_clr_with_text {
    display: flex;
    align-items: center;
    padding-right:30px;
}
.knowledge_left_clr_with_text_right_div {
    display: flex;
    justify-content: flex-end;
}
.chapter_profici_nav__right_contant {
    display: flex;
...
.aomprehension_left_clr
{
  ...
  margin: 1px 6px 1px 0;
  border-radius: 14px;
  background-color: #93d658;
  display:inline-block;
}
.application_left_clr
{
    width: 8px;
  height: 24px;
  flex-grow: 0;
...
.chapter_proficincy_point_anylytics
{
    flex-grow: 0;
...
/* .chapter_of_row_col_paddin_zero .col
{
    padding:0px;
} */
</style>
