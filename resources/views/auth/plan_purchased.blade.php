...
@section('content')
<style>
.plan_successfull_heder_icon2
{
    margin-top:10px;
}
.plan_successfull_wrapper
{
    min-height:100%;
    background:#f5faf6;
}
...
.plan_success_congrats_msg_faild
{
  font-stretch: normal;
  font-style: normal;
  letter-spacing: normal;
...
.plan_success_congrats_msg_pending
{
  font-stretch: normal;
  font-style: normal;
  letter-spacing: normal;
...
.plan_success_congrats_msg_name
{
  font-size: 18px;
  font-weight: 800;
  line-height: 1.3;
}
.plan_success_congrats_msg_text
{
  font-size: 14px;
  font-weight: 500;
  line-height: 1.4;
}
.plan_box_status_contant
{
    padding: 10px 10px;
}
.plan_box_status_contant_order_qi
{
    font-stretch: normal;
    font-style: normal;
    letter-spacing: normal;
}
.plan_box_status_contant_order
{
    font-size: 18px;
    font-weight: 600;
    line-height: 1.3;
...
.plan_successfull_go_to_dashboard
{
    width:100%;
    margin-top:25px;
    margin-bottom:5px;
}
.plan_successfull_heder_icon_img
{
    margin-top:25px;
    margin-left:25px;
}
.plan_back_to_subscription, .plan_back_to_subscription a 
{
    color:#56b663;
}
.plan_back_to_subscription
{
    padding-top:10px;
    padding-bottom:5px;
}
        ...
        <div class="plan_box_status">
            <div class="plan_box_status_msg text-center">
                ...
                <div class="plan_success_congrats_msg">
                    <div class="plan_success_congrats_msg_name">Congratulations Sakshi</div>
            ...
            <div class="plan_box_status_contant">
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-between align-items-center plan_order_sumry_subscription">
                        ...
                        <div class="plan_subscribption">TDQI-43280</div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center plan_order_sumry_subscription">
                    ...
                    <div class="d-flex justify-content-between align-items-center plan_order_sumry_subscription">
                        ...
                        <div class="plan_subscribption">20th April 2023</div>
                    </div>
                </div>
                <div class="line-692"></div>
...
<!-- Plan purchesed faild  start -->

<div class="plan_faild_wrapper" style="display:none">
    <div class="plan_successfull_heder_icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="66" viewBox="0 0 64 66" fill="none"  class="plan_successfull_heder_icon_img">
    <g filter="url(#67epj5et9a)">
        <path d="M32 6H8v24h24V6zM55.993 30.002H31.994V54h24V30z" fill="#38D430"/>
    ...
    <div class="plan_success_massage d-flex justify-content-center">
        <div class="plan_box_status">
            <div class="plan_box_status_msg_faild text-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60" fill="none" class="plan_successfull_heder_icon2">
                    <path d="M2.5 30c0-15.464 12.536-28 28-28s28 12.536 28 28-12.536 28-28 28-28-12.536-28-28z" fill="#F8BDB8"/>
                    <path d="M30.5 25.333V30m0 4.667h.012M42.167 30c0 6.443-5.224 11.667-11.667 11.667S18.834 36.443 18.834 30 24.056 18.333 30.5 18.333c6.444 0 11.667 5.224 11.667 11.667z" stroke="#D92D20" stroke-width="2.333" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M30.5 56c-14.36 0-26-11.64-26-26h-4c0 16.569 13.431 30 30 30v-4zm26-26c0 14.36-11.64 26-26 26v4c16.569 0 30-13.431 30-30h-4zm-26-26c14.36 0 26 11.64 26 26h4c0-16.569-13.431-30-30-30v4zm0-4C13.931 0 .5 13.431.5 30h4c0-14.36 11.64-26 26-26V0z" fill="#F8D7D4"/>
                </svg>                
                <div class="plan_success_congrats_msg_faild">
                    <div class="plan_success_congrats_msg_name">Payment Failed</div>
                    <div class="plan_success_congrats_msg_text">The payment for transaction ID: 1234-JEE-A-0098 could not be processed. You can retry making the payment again .</div>
                </div>
            </div>
            <div class="plan_box_status_contant">
                <div class="plan_box_status_contant_order_qi d-flex justify-content-between align-items-center"">
                ...
                <div class="line-692_field"></div>
                <div class="text-center ">
                    <button class="plan_successfull_go_to_dashboard btn btn-common-green">Retry payment</button>
                    <div class="plan_back_to_subscription">
                        <b><</b><a href="#"><u>Back to Subscription</u></a>
                    </div>
                </div>
...
<div class="plan_faild_wrapper" style="display:none">
    ...
    <div class="plan_success_massage d-flex justify-content-center">
        <div class="plan_box_status">
            <div class="plan_box_status_msg_pending text-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60" fill="none"  class="plan_successfull_heder_icon2">
                <path d="M2.5 30c0-15.464 12.536-28 28-28s28 12.536 28 28-12.536 28-28 28-28-12.536-28-28z" fill="#FFDD79"/>
                <path d="M30.5 25.333V30m0 4.667h.012m-2.007-15.33-9.882 16.496a2.333 2.333 0 0 0 1.995 3.5h19.764a2.333 2.333 0 0 0 1.995-3.5l-9.882-16.496a2.333 2.333 0 0 0-3.99 0z" stroke="#DC6803" stroke-width="2.333" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M30.5 56c-14.36 0-26-11.64-26-26h-4c0 16.569 13.431 30 30 30v-4zm26-26c0 14.36-11.64 26-26 26v4c16.569 0 30-13.431 30-30h-4zm-26-26c14.36 0 26 11.64 26 26h4c0-16.569-13.431-30-30-30v4zm0-4C13.931 0 .5 13.431.5 30h4c0-14.36 11.64-26 26-26V0z" fill="#FBE7AA"/>
            </svg>              
                <div class="plan_success_congrats_msg_pending">
                    <div class="plan_success_congrats_msg_name">Payment Pending</div>
                    <div class="plan_success_congrats_msg_text">The payment for transaction ID: 1234-JEE-A-0098 is still pending. This may be because of an error or a system restriction.</div>
                </div>
            </div>
            <div class="plan_box_status_contant">
                <div class="plan_box_status_contant_order_qi d-flex justify-content-between align-items-center"">
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-between align-items-center plan_order_sumry_subscription">
                        <div class="plan_order_summary">Order Status:</div>
                        <div class="plan_subscribption">Payment Pending</div>
                    </div>
                </div>
                <div class="line-692_field"></div>
                <div class="text-center ">
                    <button class="plan_successfull_go_to_dashboard btn btn-common-green">Go to Profile</button>
                </div>
            </div>
        <div>
    </div>
