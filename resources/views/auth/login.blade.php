...
<div id="main">
    <div class="login-box" id="name-box">
        ...
        <form id="studentlogin" method="post">
            ...
            <div id="mobile_input">
                ...
                <div class="text-center mt-5" id="mobile-input-btn">
                    <button type="button" class="btn btn-danger text-uppercase rounded-0 px-5  " onclick="sentotplogin()">Next</button>
                </div>
            </div>
        ...
        <div class="text-center"><a href="#" class="mx-4"><img src="{{URL::asset('public/images/google.png')}}"></a> <a href="#" class="mx-4"><img src="{{URL::asset('public/images/facebook.png')}}"></a></div>
