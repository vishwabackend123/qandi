...
@section('content')
    <div id="main">
        <div class="login-box" id="name-box">
            ...
            <div class="welcome-msg">Please login using your registered email/ Mobile number <img
                    src="{{URL::asset('public/images/welcome-icon.png')}}"></div>
            <form id="studentlogin" method="post">
                ...
                <div id="mobile_input">
                    <div class="text-box mt-5">
                        ...
                        <input type="text" name="login_mobile" id="mobile_num" value="" minlength="10" maxlength="10"
                    ...
                    <div class="text-center mt-5" id="mobile-input-btn">
                        <button type="button" class="btn btn-danger text-uppercase rounded-0 px-5  "
                                onclick="sentotplogin()">Next
                        </button>
                    </div>
                </div>
                ...
                <div id="input-otp-box" style="display:none">
                    <div class="text-box py-3">
                        ...
                        <input type="text" name="login_otp" id="otp_num" placeholder="Enter OTP"
                    ...
                    <p class="text-center mt-4 mb-0">Didn’t get OTP? <a href="javascript:void(0);"
                                                                        onclick="sentotplogin();">Resend</a></p>
            ...
            <p class="text-center login-txt mt-5">OR <br>Login using</p>
            <div class="text-center"><a href="{{ url('auth/google') }}" class="mx-4"><img
                        src="{{URL::asset('public/images/google.png')}}"></a>
                <a href="{{ url('auth/facebook') }}" class="mx-4"><img
                        src="{{URL::asset('public/images/facebook.png')}}"></a></div>
